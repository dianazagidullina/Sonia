...
# До 3 марта:
  Научиться работать в Google Cloud. Разобраться какие модели можно использовать. Написать простенькую версию, которая будет работать(возможно, повторить модель из статьи). Обучить её.
# До 9 марта:
